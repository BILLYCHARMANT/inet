    ...
    <div className="px-6 py-16 md:py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="text-lg text-slate-600 leading-relaxed mb-6">
          INET Maker empowers innovators through digital fabrication, smart hardware design, and hands-on technical excellence. Since 2023 we have trained hundreds of makers and supported over a thousand projects.
        </p>
